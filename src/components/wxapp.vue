<template>
  <view class="wxapp">
      ...
      <view class="third"><text class="third-text">官方认证小程序第三方服务商</text></view>
      <view class="wxbutton">
      ...
      <view class="payment"><text class="payment-text">代理缴费</text></view>
      <view class="wxprice">
        <text class="vipalone-text">小程序渠道专享</text>
        <text class="price-text">899</text>
        <text class="price-year">元/年</text>
        <text class="wxgo-text">起</text>
      </view>
  </view>
</template>
